...
class TimecardConfigController extends AbstractConfigController
{
    ...
    public function createDatabase()
    {
        ...
        $ddl->addColumn(new Floating('SUN', 2, 2));
        $ddl->addColumn(new Floating('MON', 2, 2));
        $ddl->addColumn(new Floating('TUES', 2, 2));
        $ddl->addColumn(new Floating('WED', 2, 2));
        $ddl->addColumn(new Floating('THURS', 2, 2));
        $ddl->addColumn(new Floating('FRI', 2, 2));
        $ddl->addColumn(new Floating('SAT', 2, 2));
        $ddl->addColumn(new Floating('DAYS', 2, 2)); 
